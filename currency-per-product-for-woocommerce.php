...
final class Alg_WC_CPP {
	...
	function action_links( $links ) {
		...
		if ( 'currency-per-product-for-woocommerce.php' === basename( __FILE__ ) ) {
			$custom_links[] = '<a href="https://wpfactory.com/item/currency-per-product-for-woocommerce/">' .
	...
	function includes() {
		// Functions
		require_once( 'includes/alg-wc-cpp-functions.php' );
		require_once( 'includes/alg-wc-cpp-exchange-rates-functions.php' );
		// Settings
		require_once( 'includes/admin/class-alg-wc-cpp-settings-section.php' );
		$this->settings = array();
		$this->settings['general'] = require_once( 'includes/admin/class-alg-wc-cpp-settings-general.php' );
		if ( is_admin() && get_option( 'alg_wc_cpp_version', '' ) !== $this->version ) {
		...
		// Core
		require_once( 'includes/class-alg-wc-cpp-core.php' );
	}
	...
	function add_woocommerce_settings_tab( $settings ) {
		$settings[] = include( 'includes/admin/class-alg-wc-settings-cpp.php' );
		return $settings;
	}
